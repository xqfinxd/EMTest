...
// 着色器源代码
const char* mapVertexShader = R"(#version 300 es
...
const char* mapFragmentShader = R"(#version 300 es
precision mediump float;
in vec2 TexCoord;
out vec4 FragColor;
...
const char* landmarkVertexShader = R"(#version 300 es
precision mediump float;
in vec2 aPos;
in vec2 aTexCoord;
...
const char* landmarkFragmentShader = R"(#version 300 es
precision mediump float;
in vec2 TexCoord;
out vec4 FragColor;
